...
const nav = (isCase = false) =>
  `<a class="skip" href="#main">К содержанию</a><header class="header"><a class="brand" href="/" aria-label="LandLancer — главная"><span class="brand-icon">l<span>l</span></span>landlancer<span class="brand-period">.</span></a><nav aria-label="Основная навигация"><a href="/#works">Проекты <sup>04</sup></a><a href="/#approach">Подход</a><a href="/#contact">Контакт</a></nav><a class="nav-cta" href="https://t.me/landlancer" target="_blank" rel="noopener noreferrer">Обсудить проект ${arrow}</a><button class="menu-toggle" aria-expanded="false" aria-label="Открыть меню"><span></span><span></span></button></header>${isCase ? '<div class="reading-progress" aria-hidden="true"></div>' : ""}`;
const footer = () =>
...
await writeFile(
  ...
  '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><rect width="64" height="64" rx="16" fill="#1760ee"/><path d="M17 15v34h17v-9h-8V15zm24 0v34h9V15z" fill="white"/></svg>',
);
console.log("Built homepage and 4 case studies.");

await writeFile(resolve(root, '404.html'), head('Страница не найдена', 'Вернуться в портфолио LandLancer.') + nav() + `<main id="main" class="container" style="padding:80px 0 130px"><h1>Такой страницы нет.</h1><p style="margin:30px 0">Возможно, адрес изменился. Все новые кейсы доступны на главной.</p><a class="button blue" href="/">Вернуться на главную ${right}</a></main>${footer()}</body></html>`);
